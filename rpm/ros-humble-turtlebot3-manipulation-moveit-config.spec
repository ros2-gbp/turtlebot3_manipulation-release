...
Name:           ros-humble-turtlebot3-manipulation-moveit-config
Version:        2.2.1
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS turtlebot3_manipulation_moveit_config package
...
for using the turtlebot3_manipulation with the MoveIt Motion Planning Framework
